...
export default function DeliveryLogin() {
    ...
    const handleSubmit = async (e: React.SubmitEvent) => {
        ...
        try {
            ...
            toast.success(`Bem-vindo, ${data.partner.name}!`)
    ...
    useEffect(() => {
       if(localStorage.getItem('delivery_partner') && localStorage.getItem('delivery_token')) {
            navigate("/delivery/")
       } 
    }, [navigate]);
        ...
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
                ...
                <div className="relative text-center px-12">
                    <h2 className="text-4xl font-semibold text-white mb-4">Portal do Entregador</h2>
                    <p className="text-white/60 font-serif text-xl max-w-sm mx-auto">Gerencie suas entregas e mantenha os clientes satisfeitos.</p>
                </div>
            </div>
            ...
            <div className="flex-1 flex-center px-4 py-12 bg-app-cream">
                <div className="w-full max-w-md">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-semibold text-app-green mb-2">Login Entregador</h1>
                        <p className="text-sm text-app-text-light">Faça login para gerenciar suas entregas</p>
                    </div>

                    <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 space-y-5">
                        <div>
                            <label className="block text-sm font-medium text-app-green mb-1.5">E-mail</label>
