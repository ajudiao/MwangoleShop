                                    ...
                                    <tr key={product.id} className="hover:bg-zinc-50/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <button onClick={() => handleMarkOutOfStock(product.id, product.name)} title="Marcar como fora de estoque" className="p-2 text-zinc-500 hover:text-red-600 bg-zinc-100 hover:bg-red-50 rounded-lg transition-colors">
