                ...
                {loading ? (<Loading />) : (
                    products.length === 0 ? (
                        <div className="text-center py-16">
                            ...
                            <h2 className="text-lg font-semibold text-app-green mb-2">Nenhuma oferta no momento</h2>
                            <p className="text-sm text-app-text-light">Volte em breve para ofertas incríveis</p>
                        </div>
                    ) : (
