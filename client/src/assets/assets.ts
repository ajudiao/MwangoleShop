...
export const categoriesData = [
  ...
  {
    slug: "carnes-e-mariscos",
    name: "Carnes e Mariscos",
    image: meat_seafood,
  },
  {
    slug: "snacks",
  ...
  {
    slug: "cuidados-do-bebe",
    name: "Cuidados do Bebé",
    image: baby_care,
  },
  {
    slug: "laticinios-e-ovos",
...
export const heroSectionData = {
  description:
    "Receba frutas, legumes e outros produtos agrícolas frescos diretamente dos produtores locais. Qualidade garantida, preços justos e entrega rápida.",
  ...
  hero_features: [
    {
      ...
      desc: "Receba no conforto da sua casa",
    },
    {
      icon: LeafIcon,
      title: "Produtos Frescos",
      desc: "Colhidos diretamente da fazenda",
    },
    {
      icon: ClockIcon,
      title: "Entrega no Mesmo Dia",
      desc: "Disponível em áreas selecionadas",
    },
    {
...
export const appPromoBannerData = {
  title: "Produtos frescos entregues rapidamente",

  description:
    "Faça o download da nossa aplicação e tenha acesso a promoções exclusivas, acompanhamento em tempo real das suas encomendas e uma seleção de produtos frescos diretamente dos produtores locais.",
};
